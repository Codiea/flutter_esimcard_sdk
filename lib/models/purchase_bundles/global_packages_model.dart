...
class GlobalPackagesResponseModel {
  bool? status;
  Meta? meta;
  List<DataGlobalPackagesResponseModel>? data;

  GlobalPackagesResponseModel({this.status, this.meta, this.data});

  GlobalPackagesResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    meta = json['meta'] != null ? Meta.fromJson(json['meta']) : null;
    if (json['data'] != null) {
      data = <DataGlobalPackagesResponseModel>[];
      json['data'].forEach((v) {
        data!.add(DataGlobalPackagesResponseModel.fromJson(v));
      });
    }
  }
...
class DataGlobalPackagesResponseModel {
  String? id;
  String? name;
  String? price;
  num? dataQuantity;
  ...
  DataGlobalPackagesResponseModel(
      {this.id,
      this.name,
      this.price,
      this.dataQuantity,
  ...
  DataGlobalPackagesResponseModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    price = json['price'];
