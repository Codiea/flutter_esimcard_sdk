...
class PackagesResponseModel {
  bool? status;
  Meta? meta;
  List<DataPackagesResponseModel>? data;

  PackagesResponseModel({this.status, this.meta, this.data});

  PackagesResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    meta = json['meta'] != null ? Meta.fromJson(json['meta']) : null;
    if (json['data'] != null) {
      data = <DataPackagesResponseModel>[];
      json['data'].forEach((v) {
        data!.add(DataPackagesResponseModel.fromJson(v));
      });
    }
  }
...
class DataPackagesResponseModel {
  String? id;
  String? name;
  String? price;
  num? dataQuantity;
  ...
  DataPackagesResponseModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    price = json['price'];
